...
sdirectory = './images/StanfordSimpleDogWalking';
jpgffiles = dir([sdirectory '/*.jpg']);

filepw = fopen('probWeight_hdct_stanford_leash.txt','w');
...
lablDirectory = './result_stanford'

object_name = 'leash'; %change the object name 

[path, name, ext] = fileparts(filename);

lablfilename = [lablDirectory '/' name '.labl' ];
...
imagefilename = [lablDirectory '/' name '.png' ];
grayImage = imread(imagefilename);
